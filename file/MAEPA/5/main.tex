...
\title[Lezione 5]{Un po' di SEM}
\subtitle{Master Avanzato in Economia e Politica Agraria}
\author{Giovanbattista Califano}
\date[Portici, 30/04/2026]{Scale Attitudinali per lo Studio \\ delle Preferenze del Consumatore \\ 30 Aprile 2026}
...
\begin{frame}{Tabella di marcia}
    \begin{center}
        ...
        \hline
        23/04 &  Il Questionario & $\checkmark$ \\
        \hline
        24/04 & Affidabilità e Validità di una Misura & $\checkmark$ \\
        \hline
        27/04 & Variabili Latenti: Riflessive o Formative? & $\checkmark$ \\
        \hline
