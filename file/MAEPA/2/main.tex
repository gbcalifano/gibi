...
\title[Lezione 2]{Il Questionario}
\subtitle{Master Avanzato in Economia e Politica Agraria}
\author{Giovanbattista Califano}
\date[Portici, 23/04/2026]{Scale Attitudinali per lo Studio \\ delle Preferenze del Consumatore \\ 23 Aprile 2026}
...
\begin{frame}{Modello BORIS}
    ...
    \begin{table}[]
        \centering
    \begin{tabular}{cc}
    \includegraphics[width=0.45\linewidth]{boris.png} & \includegraphics[width=0.45\linewidth]{boris2.jpg} \\
